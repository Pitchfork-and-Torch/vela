...
# Calendar / PredictiveFreeze honesty: p_ho is a past-gap estimate,
# not a next-satellite oracle. Check stamps calendar-p_ho=past-gaps.
CALENDAR_P_HO_STAMP = "past-gaps"
